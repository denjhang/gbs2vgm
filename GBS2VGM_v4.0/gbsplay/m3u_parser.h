...
struct m3u_entry {
	...
	int intro_sec;       /* Intro length in seconds (-1 if not specified) */
	int intro_ms;        /* Intro milliseconds part */
	int loop_sec;        /* Loop length in seconds (-1 if not specified) */
	int loop_ms;         /* Loop milliseconds part */
	int fade_sec;        /* Fade length in seconds (-1 if not specified) */
	int loop_count;      /* Loop count (repeat field) */
};
